...
class OrderInfo(BaseModel):
    ...
    addr = models.ForeignKey(to='user.Address', on_delete=models.CASCADE, verbose_name="地址")
...
class OrderGoods(BaseModel):
    ...
    sku = models.ForeignKey(to='goods.GoodsSKU', on_delete=models.CASCADE, verbose_name="商品SKU")
